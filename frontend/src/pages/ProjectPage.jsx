...
The aesthetic direction is "whimsical botanical garden": cream backgrounds, forest greens, teal accents, scattered doodle symbols in the margins, and an organic blob-shaped portal cycling through my work. The name Eden reflects both the garden theme and a sense of a curated, personal creative space.`,
  ...
  'tracksense-ai': {
    ...
    images: [
      { src: '/images/projects-gallery/Tracksense-homescreen.png', caption: 'The landing page, built around a live F1 broadcast feel' },
      { src: '/images/projects-gallery/tracksense-driverspage.png', caption: 'Driver ELO rankings, with a full breakdown of how each rating is calculated' },
      { src: '/images/projects-gallery/tracksense-navbar-circuitspage.png', caption: 'The circuit explorer, with track maps and per-corner detail' },
      { src: '/images/projects-gallery/tracksense-performance.png', caption: 'Lap time comparison between two drivers, with a synced hover tooltip' },
      { src: '/images/projects-gallery/Tracksense-livetelemetry.png', caption: 'The live race simulation, with real-time telemetry and a synced leaderboard' },
      { src: '/images/projects-gallery/Tracksense-navbar-aboutpage.png', caption: 'The About page, crediting the team behind the platform' },
